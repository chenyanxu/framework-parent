 ...
 */
//@Transactional
public abstract class GenericUUIDDao<T extends PersistentUUIDEntity, PK extends Serializable> implements IGenericDao<T, PK> {
     ...
     */
    public GenericUUIDDao(final Class<T> persistentClass) {
