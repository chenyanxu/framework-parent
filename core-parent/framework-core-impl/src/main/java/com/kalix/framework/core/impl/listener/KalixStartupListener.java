 ...
 * is set to true.
 * 监听karaf启动结束事件，输出启动完成的欢迎信息。
 * 参考：https://github.com/apache/karaf/blob/cffa8250da16c9be9023ea5abeaddfc3bae4e746/main/src/main/java/org/apache/karaf/main/StartupListener.java
 */
public class KalixStartupListener implements FrameworkListener, SynchronousBundleListener {
    private Logger log;
