...
import com.kalix.framework.core.api.biz.IUUIDBizService;
 ...
 * @修改备注：
 */
public abstract class GenericUUIDBizServiceImpl<T extends IGenericDao, TP extends PersistentUUIDEntity> implements IUUIDBizService<TP> {
    protected T dao;
    ...
    public GenericUUIDBizServiceImpl() {
    ...
    public void doSave(TP entity, JsonStatus jsonStatus) {
        ...
        PersistentUUIDEntity newObj = (PersistentUUIDEntity) dao.save(entity);
    ...
    @Override
    @Transactional
    public Object saveEntityAndReturn(PersistentUUIDEntity entity) {
